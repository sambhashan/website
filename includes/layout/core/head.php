<head>
    ...
    {   echo '<link type="text/css" rel="stylesheet" media="all" href="/styles/stylesheet/mobile/mobile_main.css"/>';
    }
    else{
        echo '<link rel="stylesheet" type="text/css" href="/styles/stylesheet/desktop/style_main.css">';
    };
    ?>
